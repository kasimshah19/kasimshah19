...
|--------|-----------|------------------|----------|--------|
| **B.Tech** — Computer Technology | Ahinsa Institute of Technology, Dondaicha | Dr. Babasaheb Ambedkar Technological University (DBATU) | 4 Years (From First Year) | Final Year — 🎓 2026 |
